(this["webpackJsonpmy-app"] = this["webpackJsonpmy-app"] || []).push([[3], {
    18: function (t, n, e) {
        ...
        var i, a, r = function () {
        ...
        }, s = !1, c = !1, p = function (t) {
            s = !t.persisted
        }, d = function () {
            addEventListener("pagehide", p), addEventListener("beforeunload", (function () {
            }))
        }, f = function (t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            c || (d(), c = !0), addEventListener("visibilitychange", (function (n) {
                var e = n.timeStamp;
            ...
            var n, e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = o("CLS", 0),
                a = function (t) {
                    t.hadRecentInput || (i.value += t.value, i.entries.push(t), n())
                }, r = u("layout-shift", a);
            r && (n = l(t, i, r, e), f((function (t) {
                var e = t.isUnloading;
            ...
            var n, e = o("FCP"), i = v(), a = u("paint", (function (t) {
                "first-contentful-paint" === t.name && t.startTime < i.timeStamp && (e.value = t.startTime, e.isFinal = !0, e.entries.push(t), n())
            }));
            a && (n = l(t, e, a))
        }, h = function (t) {
            var n = o("FID"), e = v(), i = function (t) {
                t.startTime < e.timeStamp && (n.value = t.processingStart - t.startTime, n.entries.push(t), n.isFinal = !0, r())
            }, a = u("first-input", i), r = l(t, n, a);
            a ? f((function () {
            ...
            var n, e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = o("LCP"), a = v(),
                r = function (t) {
                    var e = t.startTime;
            ...
            n = function () {
                try {
                    var n = performance.getEntriesByType("navigation")[0] || function () {
                        var t = performance.timing, n = {entryType: "navigation", startTime: 0};
...
//# sourceMappingURL=3.c6650b30.chunk.js.map